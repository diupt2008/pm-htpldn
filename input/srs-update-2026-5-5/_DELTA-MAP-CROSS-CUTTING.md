...
| Module | FR-04 | FR-07 | FR-10 | FR-03 | FR-12 | Profile | Hard del | ClamAV | Lưu nháp | **Final** |
|---|---|---|---|---|---|---|---|---|---|---|
| srs-v3 master | A | A | A | A | A | — | A | C | A | **A FULL** |
| FR-04 chuyen-gia-tvv | (self) | — | B | — | — | — | B | — | B⚠️ | **A FULL nếu lưu nháp rộng** |
| FR-05 vu-viec | A | B | B | — | — | — | B | B | B⚠️ | **A FULL** |
...
| FR-09 bieu-mau | B | D | C | — | — | — | B | B | B⚠️ | **A FULL nếu lưu nháp rộng** |
| FR-02 hoi-dap | B | D | B | — | — | — | B | B | C | **B DELTA** |
| FR-08 danh-gia | B | B | C | C | — | — | C | — | B⚠️ | **B DELTA** |
| FR-06 chi-tra | B | B | B | — | — | — | — | — | — | **B DELTA** |
| FR-16 api | B | B | C | B | B | — | — | — | C | **B DELTA** |
| FR-15 ct-htpldn | D | D | B | — | — | — | B | — | A⚠️ | **A FULL nếu lưu nháp rộng** |
| FR-13 tv-nhanh | D | D | B | — | C | — | — | — | C | **B DELTA** |
| FR-01 dashboard | C | C | C | C | — | — | C | — | C | **C IMPACT** |

**Total nhóm A FULL: 7 file** (vs 6 file ước tính ban đầu — thêm FR-09 + FR-15 nâng cấp khi lưu nháp scope rộng).

---

## Action ưu tiên cho QA

1. **Hỏi BA gấp 3 câu cross-cutting:**
   - Hard delete: cascade FK behavior + audit replay requirement?
   - ClamAV: alternative scan hay bỏ luôn (security regression)?
   - Lưu nháp: scope hẹp (chỉ button) hay rộng (bỏ entry state)? **Critical — block test plan 4-5 module.**
2. **BA cấp file SRS update riêng cho 3 cross-cutting** (vì impact toàn hệ thống, không thuộc module nào). Hoặc BA confirm dev tự handle, QA test integration.
3. **R7.0.5 mở rộng** — không chỉ 5 task R6 mà còn 4 task cross-cutting verify (BR-DATA-01 invalidate, virus scan bypass, draft state behavior, entry state SM-CTHTPL nếu bỏ DU_THAO).
