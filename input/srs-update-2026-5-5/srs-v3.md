...
| 16 | TU_VAN_VIEN | tvv | Thông tin TVV/CG/NHT trong mạng lưới | 2,000 |
...
| **Nhóm X.3 — Hợp đồng** | | | | |
| 47 | HOP_DONG_TU_VAN | tu-van | Hợp đồng tư vấn giữa đơn vị và TVV/tổ chức | 1,000 |
...
| 53 | CAU_HINH_PHAN_CONG | cross-cutting | Mapping lĩnh vực PL ↔ CB/TVV phụ trách | 1,000 |
...
|--------|---------|-------|---------|
| BR-AUTH-01 → BR-AUTH-12 | 12 BRs | Quy tắc xác thực, phân quyền, lọc kép, dual control | §3.2 (cross-cutting) |
