...
**Last updated:** 2026-05-08 19:50 (R7.2.7 R8 retry seed +5 NHT qua UI `/nguoi-ho-tro` — pool 4→11, CHO_KICH_HOAT:8 cover BTP-TW + BKH + BTC + STP-BG + STP-BNI, LV DN/Thuế/LĐ/SHTT) · **Account verify:** cb_nv_tw_02 + cb_nv_bn_01/02 + cb_nv_dp_02/03 + qtht_02 · **MCP:** chrome-devtools `list_network_requests` + `evaluate_script` fetch
