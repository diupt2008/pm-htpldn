...
Dev đã deploy SRS update 2026-05-05 + partial reset DB (verified 2026-05-06 qua MCP). Sau audit R7.0.6 ([ui-surface-audit.md](../output/qa-reports/round7-2026-05-06/seed/ui-surface-audit.md)):
...
- R7.0.6 cũng phát hiện 2 gap FR-07 (button [Thêm mới]/[Import Excel]) → dev fix Closed 2026-05-06 ([bug-report-r7-0-6-fr-07-buttons.md](../output/qa-reports/round7-2026-05-06/bug-reports/bug-report-r7-0-6-fr-07-buttons.md)).
