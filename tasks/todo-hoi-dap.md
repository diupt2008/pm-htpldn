...
|---|:-:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|---|
| **P3** | 3 | 1 | 0 | 1 | 1 | 0 | 0 | 0 | ⚠️[R7.3.1](#r7-3-1) · ✅[R7.3.1.MoB](#r7-3-1-mob) · 🟢[R7.3.1.TVN](#r7-3-1-tvn) |
| **P4** | 1 | 0 | 0 | 0 | 0 | 1 | 0 | 0 | 🚫[R7.4.A4](#r7-4-a4) |
| **P7** | 1 | 0 | 0 | 0 | 0 | 1 | 0 | 0 | 🚫[R7.7.1](#r7-7-1) |
| **Tổng** | **5** | **1** | **0** | **1** | **1** | **2** | **0** | **0** |  |
<!-- END: module-summary -->

## Tasks

- ⚠️ **R7.3.1** 🔄 Seed 6 Hỏi đáp entry MOI cover 6 LV × 4 kênh `[~0% UI — seed API thuần, re-test UI per rule 2026-05-07]` <a id="r7-3-1"></a>
  - **Kết quả:** PASS 6/6 cover 6 LV × 4 kênh nhưng API thuần — vi phạm rule, cần re-test UI. [seed-checklist-r7-3-1-hd.md](../output/qa-reports/round7-2026-05-06/seed/hoi-dap/seed-checklist-r7-3-1-hd.md)
...
- 🚫 **R7.4.A4** ✏️ Workflow Hỏi đáp 11 paths v3.5 `[block: BUG-HD-A4-001/002/003 chưa đóng]` <a id="r7-4-a4"></a>
  - **Cần:** BUG-HD-A4-001/002/003 đóng · ≥1 TC TV `HOAT_DONG` (✓5) · ≥3 HD `MOI` (✗2|cần 3+) hoặc `DA_PHAN_CONG` (✓3)
