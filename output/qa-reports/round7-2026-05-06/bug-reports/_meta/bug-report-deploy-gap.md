...
|--------|----------|----------|------|--------|-------------------|-------|--------|
| DEPLOY-003 | Major | P1 | UI/UX | — | `srs-update-2026-5-5/srs-fr-03-dao-tao.md` (FR-III-22 Lịch học, FR-III-NEW-01/02/03 Đề KT, KE_HOACH_DAO_TAO, HOC_VIEN) | 4 sub-menu Đào tạo mới chưa thêm vào sidebar | Open (Partial Fix 2/4) |
...
> **Re-test 2026-05-07 R8 (16:43):** ⚠️ **PARTIAL FIX (2/4)** — vẫn Open. Account cb_nv_tw_02. Click sidebar "Quản lý đào tạo, tập huấn" → render **6 sub-menu**: (1) Kế hoạch đào tạo 🆕 ✅ (2) Chương trình đào tạo (3) Khóa học (4) Ngân hàng câu hỏi (5) Giảng viên / Trợ giảng (6) Học viên 🆕 ✅. Dev đã thêm 2/4 NEW sub-menu (Kế hoạch ĐT + Học viên). Vẫn thiếu **Lịch học** (FR-III-22) + **Đề kiểm tra** (FR-III-NEW-01/02/03). Note: "Kho tài liệu" R7 báo có giờ không thấy (có thể bị remove hoặc rename). Bug giữ Open chờ dev thêm 2 sub-menu còn lại.
