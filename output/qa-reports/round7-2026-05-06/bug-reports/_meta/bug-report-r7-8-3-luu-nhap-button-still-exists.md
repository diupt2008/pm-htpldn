...
|---|---|---|---|---|---|---|---|
| BUG-LUUNHAP-01 | **Major** | P1 | Workflow | R7.8.3-TC02 | `_DELTA-MAP-CROSS-CUTTING.md C3 line 107` (scope HẸP — bỏ button [Lưu nháp]) | Form chỉnh sửa CT HTPLDN trạng thái Dự thảo CHƯA bỏ button [Lưu nháp] + thiếu [Đệ trình duyệt] → workflow CT R7.6.4 nghẽn ở DU_THAO | Open |
| BUG-LUUNHAP-02 | Medium | P2 | UI/UX | R7.8.3-TC02 | `_DELTA-MAP-CROSS-CUTTING.md C3 line 107-108` | Form CT HTPLDN edit chỉ có button "Lưu nháp" duy nhất, không có [Hủy] / [Quay lại] → user không thoát form được mà không save | Open |

---

## BUG-LUUNHAP-01 — Form CT HTPLDN trạng thái "Dự thảo" còn button [Lưu nháp], thiếu [Đệ trình duyệt]
...
- Full report: [functional-test-report-r7-8-3-luu-nhap-scope-hep.md](../../functional/functional-test-report-r7-8-3-luu-nhap-scope-hep.md) §B UI form button audit.
