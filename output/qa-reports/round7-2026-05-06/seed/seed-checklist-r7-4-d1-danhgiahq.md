...
- [Detail page sau save — DG-20260506-0001 state Lập kế hoạch + Tab Tiêu chí render đầy đủ buttons](screenshots/r7-4-d1-DG-20260506-0001-lap-ke-hoach.png)
- [List view tab "Tất cả" — 1 record DG-20260506-0001 trạng thái Lập kế hoạch](screenshots/r7-4-d1-list-1-record-lap-ke-hoach.png)
