...
🔴 **BUG-CG-A1-001 VẪN OPEN** sau dev claim fix — verify TVV-BTP-TW-0007 (CG đã approve) state vẫn `DANG_HOAT_DONG` qua API GET (không phải `CHO_KICH_HOAT` per spec). UI tab list cũng chưa có "Chờ kích hoạt". Detail: [bug-report-r7-4-a1-cg-state-deviation.md](../bug-reports/tu-van-vien-cg/bug-report-r7-4-a1-cg-state-deviation.md) blockquote "Re-test 2026-05-07".
