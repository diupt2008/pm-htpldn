...
|--------|----------|----------|------|--------|-------------------|-------|--------|
| ~~BUG-SRS-FR10-001~~ | Major | P0 | Data | FR-VIII-29 | `srs-fr-10-quan-tri.md` line 1397-1404 (FR Inputs) vs line 2059-2072 (Entity 3.4.3.51) | NGAY_LE — entity schema (single date + năm + loại) khác FR Inputs (date range + lap_lai_hang_nam) | Closed (R8) |
| ~~BUG-SRS-FR10-002~~ | Major | P0 | Data | FR-VIII-22 | `srs-fr-10-quan-tri.md` line 1032 + 1975 (FK loai='TINH_THANH') vs line 1459 (SCR-VIII-01 13 tab) | TINH_THANH — FK định nghĩa nhưng không có tab CRUD trong SCR-VIII-01 | Closed (R8) |
| ~~BUG-SRS-FR10-003~~ | Major | P0 | Workflow | SM-TAIKHOAN | `srs-fr-10-quan-tri.md` line 1061 (FR-VIII-22 bypass) vs line 1285 (FR-VIII-26 "luồng cũ") vs line 2089 (SM diagram) | CHO_PHAN_QUYEN — sau DN bypass, scenario nào còn trigger? Transition #2 + #3 trong bảng SM không có actor xác định | Closed (R8) |
...
## ~~BUG-SRS-FR10-001~~ — NGAY_LE entity schema khác FR-VIII-29 Inputs [CLOSED]

> **Re-test 2026-05-08 R8:** ✅ **CLOSED**. BA chốt 2026-05-07 Q1 (theo `ba-answers-fr10-2026-05-07.md`): NGAY_LE schema theo Entity 3.4.3.51 (single date + nam + loai). SRS file đã update — line 1402-1406 FR-VIII-29 Inputs giờ có 5 trường `ngay/nam/ten_ngay_le/loai/ghi_chu` MATCH entity (line 2067 §3.4.3.51). Không còn date range + lap_lai_hang_nam. Schema duy nhất, test CRUD chạy được trên 1 nguồn. Entity là master, FR Inputs đồng bộ.
...
## ~~BUG-SRS-FR10-002~~ — TINH_THANH FK định nghĩa nhưng SCR-VIII-01 không có tab CRUD [CLOSED]

> **Re-test 2026-05-08 R8:** ✅ **CLOSED**. BA chốt 2026-05-07 Q2: bổ sung **FR-VIII-30 Quản lý danh mục Tỉnh/Thành phố** (line 1445) + SCR-VIII-01 sidebar đổi từ 13 tab → **14 tab** (line 1496) gồm tab "Tỉnh/Thành phố" (FR-VIII-30). Entity DON_VI line 1983 update note: "63 tỉnh seed sẵn khi deploy DDL + có UI CRUD ở FR-VIII-30 cho QTHT khi sáp nhập tỉnh". DM TINH_THANH có cả init seed + CRUD path rõ ràng.
...
## ~~BUG-SRS-FR10-003~~ — CHO_PHAN_QUYEN sau bypass DN — scenario nào còn trigger? [CLOSED]

> **Re-test 2026-05-08 R8:** ✅ **CLOSED**. BA chốt 2026-05-07 Q3: **bỏ trạng thái CHO_PHAN_QUYEN**. SM-TAIKHOAN giảm 5 → 4 states (CHO_KICH_HOAT/HOAT_DONG/TAM_KHOA/VO_HIEU_HOA — entity TAI_KHOAN line 1957 CHECK constraint update). Mọi luồng tạo TK đều gán role TRƯỚC → đi thẳng `CHO_KICH_HOAT → HOAT_DONG` khi user kích hoạt. FR-VIII-22 Step 7 (line 1064) + FR-VIII-26 Step 11 (line 1288) update note "BA chốt 2026-05-07 Q3 bỏ CHO_PHAN_QUYEN". SCR-VIII-08a xóa (đồng bộ Q10 line 1798). Hết 2 dead transitions.
